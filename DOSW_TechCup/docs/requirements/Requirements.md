...
| **Precondiciones** | El actor debe tener rol de Organizador y sesión iniciada en TechCup.                                                                                                                                                                                                                                          |
| **Actor** | Organizador                                                                                                                                                                                                                                                                                                   |
| **Flujo principal** | 1. El actor accede al módulo de torneos.<br>2. El sistema muestra el formulario de creación de torneo y entra en estado "Borrador".<br>3. El actor ingresa nombre, fechas y cantidad de equipos.<br>4. El sistema valida datos obligatorios y rangos.<br>5. El sistema registra el torneo en estado “Activo”. |
