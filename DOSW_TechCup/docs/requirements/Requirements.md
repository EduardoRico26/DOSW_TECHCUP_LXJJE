...
| **Diagrama de caso de uso** | <img width="526" height="147" alt="image" src="https://github.com/user-attachments/assets/bcf2346e-c501-4f01-9252-9841bf66606b" />
...
| **Precondiciones** | Torneo existente en estado “Activo” y con condiciones mínimas de inicio cumplidas (p. ej., equipos inscritos según reglamento).                                                                                                    |
| **Actor** | Organizador                                                                                                                                                                                                                        |
...
|------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **ID** | RF-15                                                                                                                                                                                                                                                      |
| **Nombre del requerimiento** | Permitir a los capitanes buscar participantes por posición, semestre, edad, género, nombre e identificación.                                                                                                                                               |
...
| **Descripción** | El sistema debe registrar eventos relevantes de usuario y sistema para trazabilidad y auditoría.                                                                                                               |
| **Precondiciones** | Módulo de logging habilitado.                                                                                                                                                                                  |
| **Actor** | Sistema                                                                                                                                                                                                        |
| **Flujo principal** | 1. Se ejecuta una acción relevante (creación, actualización, acceso, cambio de estado, etc.).<br>2. El sistema registra el evento con metadatos (usuario, fecha/hora, entidad, acción) en un archivo de texto. |
| **Diagrama de caso de uso** | *[pendiente]*                                                                                                                                                                                                  |
